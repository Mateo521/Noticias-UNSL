	...
	foreach($array as $element =>$elm){
		...
		switch($element){
			...
			case 'titles':
				...
				$OT.= "<span class='evcal_desc2 evcal_event_title' style='text-transform:none;' itemprop='name'>". apply_filters('eventon_eventtop_maintitle',$object->title) . $editBTN."</span>";
