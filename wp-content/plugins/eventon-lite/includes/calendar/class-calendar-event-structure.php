						...
						$OT.= "<div class='evo_metarow_organizer evorow evcal_evdata_row evcal_evrow_sm ".$end_row_class."'>
								...
								<div class='evcal_evdata_cell'>							
									...
									$org_data = "<p class='evo_data_val evo_card_organizer_name'>
										...
										(!empty($event_organizer->organizer_contact)? 
										"<span class='evo_card_organizer_contact'>". stripslashes($event_organizer->organizer_contact). "</span>":null)."
										".(!empty($event_organizer->organizer_address)? 
										"<span class='evo_card_organizer_address'>". stripslashes($event_organizer->organizer_address). "</span>":null)."
										</p>";
