...
class evo_sinevent{
	...
	// @~2.6.13
		function oneevent_wrapper(){
			...
			?>
			<div id='evcal_single_event_<?php echo get_the_ID();?>' class='ajde_evcal_calendar eventon_single_event evo_sin_page<?php echo ' '. $etsty;?>' data-eid='<?php echo $event_id;?>' data-l='<?php echo $this->L;?>' data-j='<?php echo json_encode($json);?>'>
			<?php
		}
