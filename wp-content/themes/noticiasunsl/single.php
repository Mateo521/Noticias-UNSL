...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/image-slider-lightbox/dist/jquery-simple-lightbox.js"></script>
...
<div class="flex w-full justify-center p-8 bg-white" id="noticia">
    <div class="max-w-screen-md w-full" id="txt-in">
        ...
        <div id="basic">
            ...
            <a href="#" title="image2" rel="lightbox">
                <img src="#" style="max-width: 150px; max-height: 150px;">
            </a>
            <a href="#" title="image3" rel="lightbox">
                <img src="#" style="max-width: 150px; max-height: 150px;">
            </a>
        </div>
        <p>Sample images are generated by <a href="https://placeholder.com/" target="_blank">https://placeholder.com/</a></p>
        <script>
